...
const GenerateImages = () => {
    ...
    const imageStyle = ['Realistic', 'Ghibli Style', 'Anime Style', 'Cartoon Style',
      'Fantasy style', 'Realistic style', '3D style', 'Potrait style'
    ]
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
          ...
          <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
            ...
            border border-gray-300' placeholder='Describe what you want to see in the image...'
            required />
            ...
            <p className='mt-4 text-sm font-medium'>Style</p>
              ...
              <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
                {imageStyle.map((item)=>(
                  ...
                  className={`text-xs px-4 py-1 border rounded-full cursor-pointer
                   ...
                   'text-gray-500 border-gray-300'}`} key={item}>
                    {item}</span>
                ) )}
              </div>
                ...
                <div className='my-6 flex items-center gap-2'>
                  <label className='relative cursor-pointer'>
                    ...
                    checked={publish} className='peer sr-only'/>
              ...
              from-[#00AD25] to-[#04FF50] text-white px-4 py-2 mt-6 text-sm rounded-lg
              cursor-pointer'>
